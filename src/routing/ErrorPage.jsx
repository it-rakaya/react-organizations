...
export const ErrorPage = () => {
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center justify-center w-full h-screen space-x-8 space-y-16 bg-white rounded-2xl dark:bg-dark-tertiary lg:flex-row lg:space-y-0 2xl:space-x-0'>
        {/* <div className='flex flex-col items-center justify-center w-full text-center lg:w-full lg:px-2 xl:px-0'>
        ...
        <div className='justify-center w-full p-4 lg:items-end'>
          ...
          <div className='flex justify-center gap-x-3'>
            <Link
              to='/'
              className='flex items-center px-4 py-2 space-x-2 text-gray-100 transition duration-150 rounded bg-mainBlue hover:bg-blue-700'
              title={`${t('Return Home')}`}
            >
            ...
            <ButtonComp action={() => window.location.reload()}>
              {t('Reloading')}
            </ButtonComp>
          </div>
          {/* <svg
