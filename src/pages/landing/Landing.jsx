...
function Landing() {
  ...
  return (
    <div className="relative w-screen overflow-x-hidden lg:h-screen" dir="ltr">
      ...
      {/* KAABA  */}
      <div className="w-screen flex justify-end pe-[13%] xl:pe-[10%] 3xl:pe-[8%]   lg:my-32 3xl:my-64 absolute">
        <div
          className="hidden lg:block !w-[15vh] !h-[15vh] lg:!w-[19vh] lg:!h-[19vh] xl:!w-[25vh] xl:!h-[25vh]  bg-landing  z-[9999]"
