...
function AfterAndBeforeFacility({
  ...
  return (
    <Grid
      ...
      className="xl:fixed mt-5 md:mt-0 bottom-[55px] afterAndBeforeButton ltr:md:bottom-[35px] md:bottom-[20px] ltr:right-[16px] ltr:md:right-[41px] rtl:left-[16px] md:rtl:left-[41px] "
    >
      <ButtonComp
        size="large"
        type="button"
